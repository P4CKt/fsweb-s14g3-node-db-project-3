...
select ProdcutName,CategoryName from Product p join Category c on p.CategoryId=c.Id
...
select o.Id as 'SiparisID',c.CompanyName from [Order] o join Customer c on c.Id=o.CustomerId where OrderDate<'2012-08-09'
